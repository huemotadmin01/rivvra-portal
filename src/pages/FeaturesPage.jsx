...
const APPS = [
  {
    ...
    features: [
      ...
      { icon: Reply, title: 'Reply Handling', desc: 'Log a reply in one click, AI classifies its intent, and the sequence pauses. Unsubscribe links are handled automatically.' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: BarChart3, title: 'Expected Revenue', desc: 'Expected value, probability and closing date on every deal, with pipeline totals by stage.' },
      { icon: CalendarCheck, title: 'Activity Tracking', desc: 'Log calls, emails, meetings, and notes against deals.' },
      { icon: Users, title: 'Contact Management', desc: 'Deals link to the shared Contacts directory, so every client has one record.' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: CalendarCheck, title: 'Interview Scheduling', desc: 'Schedule rounds and email calendar invites (.ics) to candidates and interviewers.' },
      { icon: Briefcase, title: 'Placement Management', desc: 'Track active placements with start and end dates; assignments close automatically when they end.' },
      { icon: ListChecks, title: 'Candidate Database', desc: 'Searchable candidate pool with résumé parsing, AI scoring and duplicate detection.' },
  ...
  },
  {
    id: 'payroll',
    name: 'Payroll',
    tagline: 'Indian statutory payroll and disbursements',
    ...
    status: 'live',
    features: [
      { icon: CreditCard, title: 'Pay Processing', desc: 'Run monthly payroll from approved timesheets and attendance, with PF, ESI, PT and TDS computed for Indian entities.' },
      ...
      { icon: Settings, title: 'Pay Configuration', desc: 'Configure salary structures, statutory deductions and pay dates.' },
    ],
  },
  {
    id: 'employee',
    ...
    features: [
      ...
      { icon: FileText, title: 'Plan Templates', desc: 'Reusable onboarding plan templates for new joiners.' },
    ],
  },
  {
    id: 'contacts',
    ...
    features: [
      ...
      { icon: Layers, title: 'Cross-app Sync', desc: 'One record per company and person, shared by CRM, ATS and Invoicing.' },
    ],
  },
  {
    id: 'sign',
    ...
    status: 'live',
    features: [
      { icon: PenTool, title: 'Document Signing', desc: 'Send documents for e-signature with a complete audit trail.' },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: DollarSign, title: 'Payments & TDS', desc: 'Log payments, apply TDS, and track what is still outstanding.' },
      { icon: BarChart3, title: 'Aged Reports & Tax', desc: 'Aged receivables/payables plus GST and TDS reports for Indian entities.' },
    ],
  },
  {
    id: 'expenses',

...
import { InlineField, Panel } from '../../components/ds';
  ...
  return (
    <div className="p-3 sm:p-6 max-w-5xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        {/* Work Information */}
        <Panel title="Work Information" icon={<Building2 size={14} />}>
        ...
        <Panel title="Personal Information" icon={<User size={14} />}>
        ...
        {(() => {
          ...
          return (
            <Panel title="Address" icon={<MapPin size={14} />}>
        ...
        {/* Emergency Contact */}
        <Panel title="Emergency Contact" icon={<Phone size={14} />}>
        ...
        {isAdmin && (
          <Panel title="Bank Details" icon={<Shield size={14} />}>
      ...
      {isAdmin && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-5">
          <Panel title="Statutory Details" icon={<FileText size={14} />}>
      ...
      {Array.isArray(emp.familyMembers) && emp.familyMembers.length > 0 && (
        <div className="mt-5">
          <Panel title={`Family Members (${emp.familyMembers.length})`} icon={<Users size={14} />}>
      ...
      {Array.isArray(emp.education) && emp.education.length > 0 && (
        <div className="mt-5">
          <Panel title={`Education (${emp.education.length})`} icon={<GraduationCap size={14} />}>
            <div className="space-y-2">
      ...
      {(() => {
        ...
        return (
          <div className="mt-5">
            <Panel title={`Documents (${employeeDocs.length})`} icon={<FileText size={14} />}>
              {docsLoading ? (
      ...
      <div className="mt-5">
        <ActivityPanelV2 orgSlug={currentOrg?.slug} entityType="employee" entityId={employeeId} />
      </div>

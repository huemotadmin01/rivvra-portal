// ============================================================================
// MyAssetsV2.jsx — ESS assets list on ds (phase 16, timesheet)
// ============================================================================
// Copied from MyAssets.jsx. Read-only (assetApi list only), so this is a
// straight presentation migration: the page header moves to ds `PageHeader`.
// The fetch, the `load` callback and every asset field are untouched.
//
// The error copy is kept VERBATIM — "This isn't the same as having none
// assigned" is the entire point of that message. An employee looking at an
// empty assets page needs to know whether it failed or is genuinely empty.
// ============================================================================
...
export default function MyAssetsV2() {

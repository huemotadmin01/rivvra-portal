// ============================================================================
// MyFnfReceiptV2.jsx — ESS F&F receipt on ds (phase 16, ESS money)
// ============================================================================
// Copied from MyFnfReceipt.jsx. Header and status badge only. Every
// settlement line, the `fmt` helper and the "INR {amount}" rendering are
// byte-identical — this is a final settlement receipt, and it is the last
// money an employee is shown.
//
// ⚠️ VERIFICATION LIMIT: the staging user has no finalised settlement, so
// only the "has not been finalized yet" empty state renders. The receipt body
// — every settlement line and total — was NEVER rendered during verification
// and rests on the static diff alone. Third page in the project with this
// shape, after the GSTR-2B and bank-statement tables.
//
// I did not finalise an F&F on staging to get around it: that is a payroll
// action with real consequences, and it is on the never-trigger list.
// ============================================================================
...
import { Chip, PageHeader } from '../../components/ds';

const fmt = (n) => Number(n || 0).toLocaleString('en-IN', { maximumFractionDigits: 2 });
const fmtDate = (d) => d ? new Date(d).toLocaleDateString(undefined, { day: 'numeric', month: 'short', year: 'numeric' }) : '—';

export default function MyFnfReceiptV2() {

// ============================================================================
// LeaveMyRequestsV2.jsx — ESS leave requests on ds (phase 16, timesheet)
// ============================================================================
// Copied from LeaveMyRequests.jsx. Chrome only: the page header moves to ds.
// `cancelLeaveRequest` is byte-identical and was NOT triggered — cancelling a
// real leave request on staging to prove a header renders is not a trade
// worth making.
//
// The balance cards keep `leaveTypeBadgeClasses` from config/leaveTypes, which
// is shared with the approvals and balances screens; restyling it here would
// desynchronise three pages.
// ============================================================================
...
export default function LeaveMyRequestsV2() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <PageHeader title="My Leave Requests" sub="View and manage your leave applications" />

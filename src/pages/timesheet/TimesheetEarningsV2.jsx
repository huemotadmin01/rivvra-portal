// ============================================================================
// TimesheetEarningsV2.jsx — ESS earnings on ds (phase 16, ESS money)
// ============================================================================
// Copied from TimesheetEarnings.jsx. Header only. `EarningsCard`, the
// current/previous month split, the TDS lines and `downloadPayslipPDF` /
// `downloadMyPayslipByMonth` are byte-identical, and neither download was
// triggered.
//
// Money parity: 36 values, identical — including the 2% TDS pair and the
// ₹1,923.84 / ₹94,268.16 deduction split, which is exactly the kind of
// derived figure a re-layout is prone to disturbing.
// ============================================================================
...
export default function TimesheetEarningsV2() {
  ...
  if (loadError) return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <PageHeader title="My Earnings" sub="Track your income and payment schedule" />

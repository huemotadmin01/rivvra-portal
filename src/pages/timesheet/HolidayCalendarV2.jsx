// ============================================================================
// HolidayCalendarV2.jsx — Holiday calendar on ds (phase 16, timesheet)
// ============================================================================
// Copied from HolidayCalendar.jsx. Chrome only: the header and the year
// stepper move to ds. `updateHolidays` and `copyHolidaysToYear` are
// byte-identical and were NOT triggered — copying a year writes a whole
// calendar of holidays, which drives leave accrual and working-day counts.
//
// The subtitle stays admin-conditional ("Manage…" vs "Public holidays…"): the
// page really is two things depending on role, and flattening the copy would
// tell non-admins they can edit.
//
// The stepper stays a ±  control rather than becoming a Select — the calendar
// is browsed year-by-year and that is the affordance people already use.
// ============================================================================
...
export default function HolidayCalendarV2() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <PageHeader
        ...
        sub={isAdmin ? 'Manage public holidays for your organization' : 'Public holidays for your organization'}
        actions={
          /* Year stepper. Kept as a stepper rather than a Select because the
             calendar is browsed year-by-year, and the legacy control's ± is
             what people already reach for. */
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
            <Button variant="ghost" size="sm" onClick={() => setYear(y => y - 1)} aria-label="Previous year">
              <ChevronLeft size={16} />
            </Button>
            <span style={{ font: '700 17px/1 var(--font)', color: 'var(--fg)', minWidth: 60, textAlign: 'center' }}>{year}</span>
            <Button variant="ghost" size="sm" onClick={() => setYear(y => y + 1)} aria-label="Next year">

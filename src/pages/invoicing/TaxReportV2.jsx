// ============================================================================
// TaxReportV2.jsx — Tax report on ds (phase 14, statutory reports)
// ============================================================================
// Copied from TaxReport.jsx. The important thing on this file is the SWITCH,
// preserved exactly:
//
//     if (currentCompany?.currency === 'INR') return <GstReportV2 />;
//
// An INR company gets the statutory GST report on this route; everyone else
// gets the generic collected-vs-paid report below. They are separate
// components on purpose so a company switch remounts cleanly rather than
// changing hook order. Only the TARGET moved (GstReport -> GstReportV2), so
// both branches are on ds together — switching companies must not flip the
// page between two design systems.
//
// The non-INR branch is read-only; its header moves to ds and its figures,
// filters and tables are untouched.
// ============================================================================
...
export default function TaxReportV2() {

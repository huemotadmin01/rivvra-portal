import ReplyIntentBadge, { IcpScoreBadge } from '../components/outreach/ReplyIntentBadge';
                      ...
                      {leads.map((lead) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            ...
                            <ReplyIntentBadge lead={lead} /><IcpScoreBadge lead={lead} />
                          </td>
                          <td className="px-4 py-3">

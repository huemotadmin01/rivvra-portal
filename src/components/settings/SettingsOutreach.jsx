 ...
 * Shows Gmail connection status, EngageSettings (send limits, unsubscribe, signature),
 * and Sales Teams management (moved from SettingsTeam).
 */
import { useState, useEffect } from 'react';
import { useAuth } from '../../context/AuthContext';
import { useOrg } from '../../context/OrgContext';
import {
  Mail, CheckCircle2, XCircle, Loader2, ExternalLink,

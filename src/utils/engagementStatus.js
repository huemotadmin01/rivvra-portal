...
export const ENGAGEMENT_META = {
  ...
  on_hold: { label: 'On hold', tone: 'warn', hint: 'No open job right now, but at least one job is on hold' },
  unconverted: { label: 'Unconverted', tone: 'danger', hint: 'Sent jobs, none hired, none open or on hold' },
